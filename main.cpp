...
public:
	...
	void Add_Textures()
	{
		...
		OpenGLTextureLibrary::Instance()->Add_Texture_From_File("night.jpg", "skybox_albedo");		////TODO (Step 4): use a different texture color image here for your own mesh!
		OpenGLTextureLibrary::Instance()->Add_Texture_From_File("night.jpg", "skybox_normal");		////TODO (Step 4): use a different texture normal image here for your own mesh!
